import { AccessibleSvg } from "@/core/a11y/AccessibleSvg";

/**
 * Accessible SVG icons — no emoji, works everywhere.
 * Decorative icons use AccessibleSvg with decorative=true (aria-hidden).
 * Informative icons would use title + role=img via AccessibleSvg.
 */
...
export function IconHome({ className = "w-6 h-6" }: IconProps) {
  return (
    <AccessibleSvg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" decorative>
...
export function IconTouch({ className = "w-6 h-6" }: IconProps) {
  return (
    <AccessibleSvg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" decorative>
...
export function IconSkipForward({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
export function IconSkipBack({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
export function IconCaptureCircle({ className = "w-6 h-6" }: IconProps) {
  return (
