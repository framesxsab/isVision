    ...
    >
      <div className="flex items-start justify-between gap-3 mb-4">
        ...
        <button
          ...
          className="shrink-0 inline-flex items-center justify-center w-9 h-9 rounded-full text-stone-400 hover:text-stone-100 hover:bg-white/8 focus-visible:ring-2 focus-visible:ring-primary-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#07090c] transition-colors"
        >
